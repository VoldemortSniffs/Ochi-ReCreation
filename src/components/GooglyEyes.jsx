...
function GooglyEyes() {
  ...
  return (
    <div className="eyes w-full h-screen overflow-hidden rounded-tl-2xl rounded-tr-2xl">
      <div
        data-scroll
        data-scroll-speed="-.7"
      ...
      >
        <div className="absolute flex gap-10 top-1/2 left-1/2 -translate-x-[55%] -translate-y-[95%]">
          <div className="flex items-center justify-center w-[12vw] h-[12vw] rounded-full bg-zinc-100">
            <div className="relative w-2/3 h-2/3 rounded-full bg-zinc-900">
              <div className="font-com font-light text-white uppercas translate-x-[30%] translate-y-[140%]">
                PLAY
              </div>
              <div
                style={{
