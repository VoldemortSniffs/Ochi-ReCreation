...
function Footer() {
  return (
    <div className="w-full h-screen flex gap-5 bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-bangla">
        <div className="heading">
          <h1 className="text-[8vw] -mb-8 uppercase font-semibold leading-none">
            Final
          </h1>
          <h1 className="text-[8vw] -mb-8 uppercase font-semibold leading-none">
            Bang
          ...
          <div className="flex gap-2 px-1">
            <div className="w-[8vw] border-[2px] border-zinc-100 mt-10">
              <div className="bg-zinc-100 w-[2vw] h-[1vw]"></div>
            </div>
          </div>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[7vw] -mb-8 uppercase font-bangla tracking-tighter font-semibold leading-none">
          Presentations
        </h1>
        <div className="details font-com uppercase mt-20 underline">
          <a className="block text-xl font-light mb-3" href="#">
            LinkedIn
          </a>
        ...
        <div className="w-[90vh] h-[50vh] flex items-center justify-center overflow-hidden rounded-xl bg-zinc-500 mt-10">
          <img
